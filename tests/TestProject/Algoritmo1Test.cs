...
namespace TestProject
{
    public class Algoritmo1Test
    {
        ...
        public void Run_EncuentraRutaCorrecta()
        {
            ...
            var result = Algoritmo1_Dijkstra.Run(matrix, 0, 3, token);
        ...
        public void Run_NoEncuentraRuta()
        {
            ...
            var result = Algoritmo1_Dijkstra.Run(matrix, 0, 2, token);
        ...
        public void Run_OrigenIgualDestino()
        {
            ...
            var result = Algoritmo1_Dijkstra.Run(matrix, 0, 0, token);
        ...
        public void Run_CancelacionRetornaFalse()
        {
            ...
            var result = Algoritmo1_Dijkstra.Run(matrix, 0, 2, cts.Token);
